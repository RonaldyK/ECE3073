...
$(MEM_1)_START := 0x04004000
$(MEM_1)_END := 0x04007fff
$(MEM_1)_SPAN := 0x00004000
$(MEM_1)_HIERARCHICAL_PATH := SRAM
$(MEM_1)_WIDTH := 32
...
.PHONY: SRAM
SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
